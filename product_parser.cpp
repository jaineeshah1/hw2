...
{
    Book* b = new Book("book", prodName_, price_, qty_, author_, isbn_);
    return b;
}
...
{
    Clothing* c = new Clothing("book", prodName_, price_, qty_, brand_);
    return c;
}
...
{
    Movie* m = new Movie("book", prodName_, price_, qty_, genre_, rating_);
    return m;
}
